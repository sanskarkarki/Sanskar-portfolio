        ...
        if (closestObj) {
            ...
            if (target.poiId) {
                ...
                if (entry && translatedEntry) {
                    ...
                    if (entry.actions) {
                        for (const action of entry.actions) {
                            if (
                                ...
                                const label =
                                    translatedEntry.actions[action.id as keyof typeof translatedEntry.actions] ||
                                    action.label;
                    ...
                    if (localPage) {
                        const label =
                            translatedEntry.actions[
                                localPage.actionId as keyof typeof translatedEntry.actions
                            ];
